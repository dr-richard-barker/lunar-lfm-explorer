...
\centering
\footnotesize
\caption{\textbf{Systematic synthesis of documented biological responses and biophysical mechanisms under hypomagnetic field (HMF) conditions.} Summary of peer-reviewed experimental literature across plant, microbial, invertebrate, and mammalian/human systems.}
\label{tab:unified_biology_literature}
